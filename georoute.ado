...
*! version 4.1 by Sylvain Weber, Martin Péclat & August Warren 09may2022
/*
Revision history:
...
* Hua Peng: changed two lines to check return from hereapi after -insheetjson- to be ""
* currently it's only checking "[]", which can end in an infinite loop if 
* there is no route between origin and destination 
